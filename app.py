...
<style>
    ...
    div[role="radiogroup"] > label {background-color: #33689e; color: var(--text-muted-color); padding: 10px 18px; border-radius: var(--border-radius); border: 1px solid var(--input-border-color); cursor: pointer; transition: background-color 0.2s ease, border-color 0.2s ease, color 0.2s ease; font-size: 0.95em; font-weight: 500;}
